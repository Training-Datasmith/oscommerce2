...
$OSCOM_Language->load_definitions('ssl_check');
$breadcrumb->add(OSCOM::get_def('navbar_title'), OSCOM::link('ssl_check.php'));
...
?>
    ...
    <div class="panel panel-danger">
      <div class="panel-body">
        <?php 
echo OSCOM::get_def('text_information', ['contact_us_url' => OSCOM::link('contact_us.php')]);
?>
      </div>
    </div>
  </div>
