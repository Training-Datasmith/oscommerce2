...
$OSCOM_Language->load_definitions('products_new');
$breadcrumb->add(OSCOM::get_def('navbar_title'), OSCOM::link('products_new.php'));
...
$Qlisting->set_page_set(MAX_DISPLAY_SEARCH_RESULTS);
$Qlisting->execute();
