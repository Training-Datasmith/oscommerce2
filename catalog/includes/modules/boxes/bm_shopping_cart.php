...
class bm_shopping_cart
{
    ...
    {
        $this->title = OSCOM::get_def('module_boxes_shopping_cart_title');
        $this->description = OSCOM::get_def('module_boxes_shopping_cart_description');
    ...
    {
        global $new_products_id_in_cart, $currencies, $osc_template;
        ...
        if ($_SESSION['cart']->count_contents() > 0) {
            ...
            $cart_contents_string .= '<p>' . OSCOM::get_def('module_boxes_shopping_cart_box_cart_empty') . '</p>';
        }
        ob_start();
    ...
    public function install(): void
    {
        ...
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Enable Shopping Cart Module', 'configuration_key' => 'MODULE_BOXES_SHOPPING_CART_STATUS', 'configuration_value' => 'True', 'configuration_description' => 'Do you want to add the module to your shop?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'True\', \'False\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Content Placement', 'configuration_key' => 'MODULE_BOXES_SHOPPING_CART_CONTENT_PLACEMENT', 'configuration_value' => 'Right Column', 'configuration_description' => 'Should the module be loaded in the left or right column?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'Left Column\', \'Right Column\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_BOXES_SHOPPING_CART_SORT_ORDER', 'configuration_value' => '0', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
    }
    ...
    {
        return ['MODULE_BOXES_SHOPPING_CART_STATUS', 'MODULE_BOXES_SHOPPING_CART_CONTENT_PLACEMENT', 'MODULE_BOXES_SHOPPING_CART_SORT_ORDER'];
    }
}