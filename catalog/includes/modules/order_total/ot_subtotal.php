...
class ot_subtotal
{
    ...
    public function __construct()
    {
        ...
        $this->title = OSCOM::get_def('module_order_total_subtotal_title');
        $this->description = OSCOM::get_def('module_order_total_subtotal_description');
    ...
    public function install(): void
    {
        ...
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Display Sub-Total', 'configuration_key' => 'MODULE_ORDER_TOTAL_SUBTOTAL_STATUS', 'configuration_value' => 'true', 'configuration_description' => 'Do you want to display the order sub-total cost?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'true\', \'false\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_ORDER_TOTAL_SUBTOTAL_SORT_ORDER', 'configuration_value' => '1', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
    }
