...
class ot_shipping
{
    ...
    public function __construct()
    {
        ...
        $this->title = OSCOM::get_def('module_order_total_shipping_title');
        $this->description = OSCOM::get_def('module_order_total_shipping_description');
    ...
    public function process(): void
    {
        ...
        if (MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING == 'true') {
            ...
            if ($pass == true && $order->info['total'] - $order->info['shipping_cost'] >= MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER) {
                $order->info['shipping_method'] = OSCOM::get_def('free_shipping_title');
        ...
        if (tep_not_null($order->info['shipping_method'])) {
            ...
            $this->output[] = ['title' => $order->info['shipping_method'] . ':', 'text' => $currencies->format($order->info['shipping_cost'], true, $order->info['currency'], $order->info['currency_value']), 'value' => $order->info['shipping_cost']];
        }
    }
    ...
    public function install(): void
    {
        ...
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Display Shipping', 'configuration_key' => 'MODULE_ORDER_TOTAL_SHIPPING_STATUS', 'configuration_value' => 'true', 'configuration_description' => 'Do you want to display the order shipping cost?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'true\', \'false\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_ORDER_TOTAL_SHIPPING_SORT_ORDER', 'configuration_value' => '2', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Allow Free Shipping', 'configuration_key' => 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING', 'configuration_value' => 'false', 'configuration_description' => 'Do you want to allow free shipping?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'true\', \'false\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Free Shipping For Orders Over', 'configuration_key' => 'MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER', 'configuration_value' => '50', 'configuration_description' => 'Provide free shipping for orders over the set amount.', 'configuration_group_id' => '6', 'sort_order' => '1', 'use_function' => 'currencies->format', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Provide Free Shipping For Orders Made', 'configuration_key' => 'MODULE_ORDER_TOTAL_SHIPPING_DESTINATION', 'configuration_value' => 'national', 'configuration_description' => 'Provide free shipping for orders sent to the set destination.', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'national\', \'international\', \'both\'), ', 'date_added' => 'now()']);
    }
