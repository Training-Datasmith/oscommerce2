...
class ht_opensearch
{
    ...
    {
        $this->title = OSCOM::get_def('module_header_tags_opensearch_title');
        $this->description = OSCOM::get_def('module_header_tags_opensearch_description');
    ...
    {
        global $osc_template;
        $osc_template->add_block('<link rel="search" type="application/opensearchdescription+xml" href="' . OSCOM::link('opensearch.php', '', false) . '" title="' . HTML::output(STORE_NAME) . '" />', $this->group);
    }
