...
class MCAPI
{
    ...
    {
        $this->api_url = parse_url('http://api.mailchimp.com/' . $this->version . '/?output=php');
        if (isset($GLOBALS['mc_api_key']) && $GLOBALS['mc_api_key'] != '') {
            ...
            $this->api_key = $this->call_server('login', ['username' => $username_or_apikey, 'password' => $password]);
    ...
    public function use_secure($val): void
    {
        if ($val === true) {
            $this->secure = true;
        } else {
     ...
     */
    public function campaign_unschedule($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignUnschedule', $params);
    }
    /**
     ...
     * @return boolean true on success
     */
    public function campaign_schedule($cid, $schedule_time, $schedule_time_b = null)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['schedule_time'] = $schedule_time;
        $params['schedule_time_b'] = $schedule_time_b;
        return $this->call_server('campaignSchedule', $params);
    }
    /**
     ...
     * @return boolean true on success
     */
    public function campaign_resume($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignResume', $params);
    }
    /**
     ...
     * @return boolean true on success
     */
    public function campaign_pause($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignPause', $params);
    }
    /**
     ...
     * @return boolean true on success
     */
    public function campaign_send_now($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignSendNow', $params);
    }
    /**
     ...
     * @return boolean true on success
     */
    public function campaign_send_test($cid, $test_emails = [], $send_type = null)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['test_emails'] = $test_emails;
        $params['send_type'] = $send_type;
        return $this->call_server('campaignSendTest', $params);
    }
    /**
    ...
    {
        $params = [];
        return $this->call_server('campaignTemplates', $params);
    }
    /**
    ...
    */
    public function campaign_segment_test($list_id, $options)
    {
        $params = [];
        $params['list_id'] = $list_id;
        $params['options'] = $options;
        return $this->call_server('campaignSegmentTest', $params);
    }
    /**
    ...
    */
    public function campaign_create($type, $options, $content, $segment_opts = null, $type_opts = null)
    {
        $params = [];
        $params['type'] = $type;
        $params['options'] = $options;
        ...
        return $this->call_server('campaignCreate', $params);
    }
     ...
     */
    public function campaign_update($cid, $name, $value)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['name'] = $name;
        $params['value'] = $value;
        return $this->call_server('campaignUpdate', $params);
    }
     ...
     */
    public function campaign_replicate($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignReplicate', $params);
    }
     ...
     */
    public function campaign_delete($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignDelete', $params);
    }
    /**
    ...
    */
    public function campaigns($filters = [], $start = 0, $limit = 25)
    {
        ...
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaigns', $params);
    }
    /**
     ...
     */
    public function campaign_folders()
    {
        $params = [];
        return $this->call_server('campaignFolders', $params);
    }
    /**
     ...
     */
    public function campaign_stats($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignStats', $params);
    }
    /**
     ...
     */
    public function campaign_click_stats($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignClickStats', $params);
    }
    /**
     ...
     */
    public function campaign_email_domain_performance($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignEmailDomainPerformance', $params);
    }
    /**
     ...
     */
    public function campaign_hard_bounces($cid, $start = 0, $limit = 1000)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignHardBounces', $params);
    }
    /**
     ...
     */
    public function campaign_soft_bounces($cid, $start = 0, $limit = 1000)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignSoftBounces', $params);
    }
    /**
     ...
     */
    public function campaign_unsubscribes($cid, $start = 0, $limit = 1000)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignUnsubscribes', $params);
    }
    /**
     ...
     */
    public function campaign_abuse_reports($cid, $since = null, $start = 0, $limit = 500)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['since'] = $since;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignAbuseReports', $params);
    }
    /**
     ...
     */
    public function campaign_advice($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignAdvice', $params);
    }
    /**
     ...
     */
    public function campaign_analytics($cid)
    {
        $params = [];
        $params['cid'] = $cid;
        return $this->call_server('campaignAnalytics', $params);
    }
    /**
     ...
     */
    public function campaign_bounce_messages($cid, $start = 0, $limit = 25, $since = null)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        $params['since'] = $since;
        return $this->call_server('campaignBounceMessages', $params);
    }
    /**
     ...
     */
    public function campaign_ecomm_orders($cid, $start = 0, $limit = 100, $since = null)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        $params['since'] = $since;
        return $this->call_server('campaignEcommOrders', $params);
    }
    /**
    ...
    */
    public function campaign_share_report($cid, $opts = [])
    {
        $params = [];
        $params['cid'] = $cid;
        $params['opts'] = $opts;
        return $this->call_server('campaignShareReport', $params);
    }
    /**
     ...
     */
    public function campaign_content($cid, $for_archive = true)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['for_archive'] = $for_archive;
        return $this->call_server('campaignContent', $params);
    }
    /**
     ...
     */
    public function campaign_opened_aim($cid, $start = 0, $limit = 1000)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignOpenedAIM', $params);
    }
    /**
     ...
     */
    public function campaign_not_opened_aim($cid, $start = 0, $limit = 1000)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignNotOpenedAIM', $params);
    }
    /**
     ...
     */
    public function campaign_click_detail_aim($cid, $url, $start = 0, $limit = 1000)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['url'] = $url;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignClickDetailAIM', $params);
    }
    /**
     ...
     */
    public function campaign_email_stats_aim($cid, $email_address)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['email_address'] = $email_address;
        return $this->call_server('campaignEmailStatsAIM', $params);
    }
    /**
     ...
     * @returnf string url For clicks, the URL that was clicked
     */
    public function campaign_email_stats_aim_all($cid, $start = 0, $limit = 100)
    {
        $params = [];
        $params['cid'] = $cid;
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('campaignEmailStatsAIMAll', $params);
    }
    /**
    ...
    */
    public function campaign_ecomm_add_order($order)
    {
        $params = [];
        $params['order'] = $order;
        return $this->call_server('campaignEcommAddOrder', $params);
    }
    /**
    ...
    {
        $params = [];
        return $this->call_server('lists', $params);
    }
    /**
     ...
     */
    public function list_merge_vars($id)
    {
        $params = [];
        $params['id'] = $id;
        return $this->call_server('listMergeVars', $params);
    }
    /**
    ...
    */
    public function list_merge_var_add($id, $tag, $name, $req = [])
    {
        $params = [];
        $params['id'] = $id;
        $params['tag'] = $tag;
        $params['name'] = $name;
        $params['req'] = $req;
        return $this->call_server('listMergeVarAdd', $params);
    }
    /**
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    public function list_merge_var_update($id, $tag, $options)
    {
        $params = [];
        $params['id'] = $id;
        $params['tag'] = $tag;
        $params['options'] = $options;
        return $this->call_server('listMergeVarUpdate', $params);
    }
    /**
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    public function list_merge_var_del($id, $tag)
    {
        $params = [];
        $params['id'] = $id;
        $params['tag'] = $tag;
        return $this->call_server('listMergeVarDel', $params);
    }
    /**
     ...
     */
    public function list_interest_groups($id)
    {
        $params = [];
        $params['id'] = $id;
        return $this->call_server('listInterestGroups', $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    public function list_interest_group_add($id, $group_name)
    {
        $params = [];
        $params['id'] = $id;
        $params['group_name'] = $group_name;
        return $this->call_server('listInterestGroupAdd', $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    public function list_interest_group_del($id, $group_name)
    {
        $params = [];
        $params['id'] = $id;
        $params['group_name'] = $group_name;
        return $this->call_server('listInterestGroupDel', $params);
    }
     ...
     * @return bool true if the request succeeds, otherwise an error will be thrown
     */
    public function list_interest_group_update($id, $old_name, $new_name)
    {
        $params = [];
        $params['id'] = $id;
        $params['old_name'] = $old_name;
        $params['new_name'] = $new_name;
        return $this->call_server('listInterestGroupUpdate', $params);
    }
     ...
     */
    public function list_webhooks($id)
    {
        $params = [];
        $params['id'] = $id;
        return $this->call_server('listWebhooks', $params);
    }
    /** Add a new Webhook URL for the given list
        ...
        */
    public function list_webhook_add($id, $url, $actions = [], $sources = [])
    {
        $params = [];
        $params['id'] = $id;
        $params['url'] = $url;
        ...
        return $this->call_server('listWebhookAdd', $params);
    }
     ...
     */
    public function list_webhook_del($id, $url)
    {
        $params = [];
        $params['id'] = $id;
        $params['url'] = $url;
        return $this->call_server('listWebhookDel', $params);
    }
    /**
    ...
    */
    public function list_subscribe($id, $email_address, $merge_vars, $email_type = 'html', $double_optin = true, $update_existing = false, $replace_interests = true, $send_welcome = false)
    {
        $params = [];
        $params['id'] = $id;
        $params['email_address'] = $email_address;
        ...
        return $this->call_server('listSubscribe', $params);
    }
    /**
     ...
     * @return boolean true on success, false on failure. When using MCAPI.class.php, the value can be tested and error messages pulled from the MCAPI object (see below)
     */
    public function list_unsubscribe($id, $email_address, $delete_member = false, $send_goodbye = true, $send_notify = true)
    {
        $params = [];
        $params['id'] = $id;
        $params['email_address'] = $email_address;
        ...
        return $this->call_server('listUnsubscribe', $params);
    }
    /**
     ...
     */
    public function list_update_member($id, $email_address, $merge_vars, $email_type = '', $replace_interests = true)
    {
        $params = [];
        $params['id'] = $id;
        $params['email_address'] = $email_address;
        ...
        $params['email_type'] = $email_type;
        $params['replace_interests'] = $replace_interests;
        return $this->call_server('listUpdateMember', $params);
    }
    /**
     ...
     */
    public function list_batch_subscribe($id, $batch, $double_optin = true, $update_existing = false, $replace_interests = true)
    {
        $params = [];
        $params['id'] = $id;
        $params['batch'] = $batch;
        ...
        $params['update_existing'] = $update_existing;
        $params['replace_interests'] = $replace_interests;
        return $this->call_server('listBatchSubscribe', $params);
    }
    /**
     ...
     */
    public function list_batch_unsubscribe($id, $emails, $delete_member = false, $send_goodbye = true, $send_notify = false)
    {
        $params = [];
        $params['id'] = $id;
        ...
        $params['send_goodbye'] = $send_goodbye;
        $params['send_notify'] = $send_notify;
        return $this->call_server('listBatchUnsubscribe', $params);
    }
    /**
     ...
     */
    public function list_members($id, $status = 'subscribed', $since = null, $start = 0, $limit = 100)
    {
        $params = [];
        $params['id'] = $id;
        ...
        $params['start'] = $start;
        $params['limit'] = $limit;
        return $this->call_server('listMembers', $params);
    }
    /**
     ...
     */
    public function list_member_info($id, $email_address)
    {
        $params = [];
        $params['id'] = $id;
        $params['email_address'] = $email_address;
        return $this->call_server('listMemberInfo', $params);
    }
    /**
     * Get all email addresses that complained about a given campaign
     *
     ...
     * @returnf string type an internal type generally specifying the orginating mail provider - may not be useful outside of filling report views
     */
    public function list_abuse_reports($id, $start = 0, $limit = 500, $since = null)
    {
        $params = [];
        $params['id'] = $id;
        $params['start'] = $start;
        $params['limit'] = $limit;
        $params['since'] = $since;
        return $this->call_server('listAbuseReports', $params);
    }
    /**
     ...
     */
    public function list_growth_history($id)
    {
        $params = [];
        $params['id'] = $id;
        return $this->call_server('listGrowthHistory', $params);
    }
    /**
    ...
    {
        $params = [];
        return $this->call_server('getAffiliateInfo', $params);
    }
    /**
    ...
    {
        $params = [];
        return $this->call_server('getAccountDetails', $params);
    }
    /**
     ...
     */
    public function generate_text($type, $content)
    {
        $params = [];
        $params['type'] = $type;
        $params['content'] = $content;
        return $this->call_server('generateText', $params);
    }
    /**
     ...
     */
    public function inline_css($html, $strip_css = false)
    {
        $params = [];
        $params['html'] = $html;
        $params['strip_css'] = $strip_css;
        return $this->call_server('inlineCss', $params);
    }
    /**
    ...
    public function create_folder($name)
    {
        $params = [];
        $params['name'] = $name;
        return $this->call_server('createFolder', $params);
    }
    /**
    ...
    public function apikeys($username, $password, $expired = false)
    {
        ...
        return $this->call_server('apikeys', $params);
    }
    /**
     ...
     */
    public function apikey_add($username, $password)
    {
        $params = [];
        $params['username'] = $username;
        $params['password'] = $password;
        return $this->call_server('apikeyAdd', $params);
    }
    /**
     ...
     */
    public function apikey_expire($username, $password)
    {
        $params = [];
        $params['username'] = $username;
        $params['password'] = $password;
        return $this->call_server('apikeyExpire', $params);
    }
    /**
    ...
    {
        $params = [];
        return $this->call_server('ping', $params);
    }
    /**
    ...
    {
        $params = [];
        return $this->call_server('callMethod', $params);
    }
    /**
     * Actually connect to the server and call the requested methods, parsing the result
     * You should never have to call this function manually
     */
    public function call_server(string $method, array $params)
    {
        ...
        $this->error_message = '';
        $this->error_code = '';
        $post_vars = $this->http_build_query($params);
        $payload = 'POST ' . $this->api_url['path'] . '?' . $this->api_url['query'] . '&method=' . $method . " HTTP/1.0\r\n";
        $payload .= 'Host: ' . $host . "\r\n";
     ...
     */
    public function http_build_query($params, $key = null): string
    {
        $ret = [];
        foreach ((array) $params as $name => $val) {
            ...
            if (is_array($val) || is_object($val)) {
                $ret[] = $this->http_build_query($val, $name);
            } elseif ($val !== null) {
