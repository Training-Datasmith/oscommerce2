...
class sb_pinterest
{
    ...
    {
        $this->title = OSCOM::get_def('module_social_bookmarks_pinterest_title');
        $this->public_title = OSCOM::get_def('module_social_bookmarks_pinterest_public_title');
        $this->description = OSCOM::get_def('module_social_bookmarks_pinterest_description');
    ...
    public function get_output(): string
    {
        ...
        $osc_template->add_block('<script src="//assets.pinterest.com/js/pinit.js"></script>', 'footer_scripts');
        $params = [];
        ...
        if (!empty($Qimage->value('products_image'))) {
            ...
            $params['media'] = OSCOM::link_image($image_file);
        }
        // url
    ...
    {
        $OSCOM_Db = Registry::get('Db');
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Enable Pinterest Module', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_PINTEREST_STATUS', 'configuration_value' => 'True', 'configuration_description' => 'Do you want to allow Pinterest Button?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'True\', \'False\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Layout Position', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_PINTEREST_BUTTON_COUNT_POSITION', 'configuration_value' => 'None', 'configuration_description' => 'Horizontal or Vertical or None', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'Horizontal\', \'Vertical\', \'None\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_PINTEREST_SORT_ORDER', 'configuration_value' => '0', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
    }
