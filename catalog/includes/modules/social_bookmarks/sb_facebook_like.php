...
class sb_facebook_like
{
    ...
    {
        $this->title = OSCOM::get_def('module_social_bookmarks_facebook_like_title');
        $this->public_title = OSCOM::get_def('module_social_bookmarks_facebook_like_public_title');
        $this->description = OSCOM::get_def('module_social_bookmarks_facebook_like_description');
    ...
    public function install(): void
    {
        ...
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Enable Facebook Like Module', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_STATUS', 'configuration_value' => 'True', 'configuration_description' => 'Do you want to allow products to be shared through Facebook Like?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'True\', \'False\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Layout Style', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_STYLE', 'configuration_value' => 'Standard', 'configuration_description' => 'Determines the size and amount of social context next to the button.', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'Standard\', \'Button Count\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Show Faces', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_FACES', 'configuration_value' => 'False', 'configuration_description' => 'Show profile pictures below the button?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'True\', \'False\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Width', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_WIDTH', 'configuration_value' => '125', 'configuration_description' => 'The width of the iframe in pixels.', 'configuration_group_id' => '6', 'sort_order' => '1', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Verb to Display', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_VERB', 'configuration_value' => 'Like', 'configuration_description' => 'The verb to display in the button.', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'Like\', \'Recommend\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Color Scheme', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_SCHEME', 'configuration_value' => 'Light', 'configuration_description' => 'The color scheme of the button.', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'Light\', \'Dark\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_FACEBOOK_LIKE_SORT_ORDER', 'configuration_value' => '0', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
    }
