...
class sb_twitter_button
{
    ...
    {
        $this->title = OSCOM::get_def('module_social_bookmarks_twitter_button_title');
        $this->public_title = OSCOM::get_def('module_social_bookmarks_twitter_button_public_title');
        $this->description = OSCOM::get_def('module_social_bookmarks_twitter_button_description');
    ...
    public function get_output(): string
    {
        ...
        return '<script src="http://platform.twitter.com/widgets.js" type="text/javascript"></script><a href="http://twitter.com/share?' . $params . '" target="_blank" class="twitter-share-button">' . HTML::output_protected($this->public_title) . '</a>';
    }
    ...
    public function install(): void
    {
        ...
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Enable Twitter Button Module', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_STATUS', 'configuration_value' => 'True', 'configuration_description' => 'Do you want to allow products to be shared through Twitter Button?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'True\', \'False\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Shop Owner Twitter Account', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_ACCOUNT', 'configuration_value' => '', 'configuration_description' => 'The Twitter account to attribute the tweet to and is recommended to the user to follow.', 'configuration_group_id' => '6', 'sort_order' => '1', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Related Twitter Account', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_RELATED_ACCOUNT', 'configuration_value' => '', 'configuration_description' => 'A related Twitter account that is also recommended to the user to follow.', 'configuration_group_id' => '6', 'sort_order' => '1', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Related Twitter Account Description', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_RELATED_ACCOUNT_DESC', 'configuration_value' => '', 'configuration_description' => 'A description for the related Twitter account.', 'configuration_group_id' => '6', 'sort_order' => '1', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Count Position', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_COUNT_POSITION', 'configuration_value' => 'Horizontal', 'configuration_description' => 'The position of the counter.', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'Horizontal\', \'Vertical\', \'None\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_SOCIAL_BOOKMARKS_TWITTER_BUTTON_SORT_ORDER', 'configuration_value' => '0', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
    }
