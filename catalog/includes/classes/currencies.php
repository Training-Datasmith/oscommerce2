...
class currencies
{
    ...
    public function format_raw($number, $calculate_currency_value = true, $currency_type = '', $currency_value = ''): string
    {
        if (empty($currency_type)) {
            $currency_type = $_SESSION['currency'];
        }
