...
class order
{
    ...
    public function query($order_id): void
    {
        ...
        $this->customer = ['id' => $Qorder->valueInt('customers_id'),
                                ...
                                'country' => ['title' => $Qorder->value('customers_country')],
        ...
        $this->delivery = ['name' => $Qorder->value('delivery_name'),
                                ...
                                'country' => ['title' => $Qorder->value('delivery_country')],
        ...
        $this->billing = ['name' => $Qorder->value('billing_name'),
                               ...
                               'country' => ['title' => $Qorder->value('billing_country')],
    ...
    public function cart(): void
    {
        ...
        $billing_address = ['entry_firstname' => null,
                                 'entry_lastname' => null,
                                 'entry_company' => null,
                                 'entry_street_address' => null,
                                 'entry_suburb' => null,
