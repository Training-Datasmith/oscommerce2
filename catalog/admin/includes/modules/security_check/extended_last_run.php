...
use OSC\OM\OSCOM;
use OSC\OM\Registry;
class Security_Check_extended_last_run
{
    public $type = 'warning';
    protected $lang;
    public function __construct()
    {
        ...
        $this->lang->load_definitions('modules/security_check/extended_last_run');
    }
    ...
    {
        return '<a href="' . OSCOM::link('security_checks.php') . '">' . OSCOM::get_def('module_security_check_extended_last_run_old') . '</a>';
    }
}