...
class d_total_customers
{
    ...
    {
        $this->title = OSCOM::get_def('module_admin_dashboard_total_customers_title');
        $this->description = OSCOM::get_def('module_admin_dashboard_total_customers_description');
    ...
    public function get_output(): string
    {
        ...
        $chart_label = HTML::output(OSCOM::get_def('module_admin_dashboard_total_customers_chart_link'));
    ...
    {
        $OSCOM_Db = Registry::get('Db');
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Enable Total Customers Module', 'configuration_key' => 'MODULE_ADMIN_DASHBOARD_TOTAL_CUSTOMERS_STATUS', 'configuration_value' => 'True', 'configuration_description' => 'Do you want to show the total customers chart on the dashboard?', 'configuration_group_id' => '6', 'sort_order' => '1', 'set_function' => 'tep_cfg_select_option(array(\'True\', \'False\'), ', 'date_added' => 'now()']);
        $OSCOM_Db->save('configuration', ['configuration_title' => 'Sort Order', 'configuration_key' => 'MODULE_ADMIN_DASHBOARD_TOTAL_CUSTOMERS_SORT_ORDER', 'configuration_value' => '0', 'configuration_description' => 'Sort order of display. Lowest is displayed first.', 'configuration_group_id' => '6', 'sort_order' => '0', 'date_added' => 'now()']);
    }
