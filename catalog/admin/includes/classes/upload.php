  ...
  */
  ...
  class upload {
    ...
    function save(): bool {
      ...
      if (!str_ends_with((string) $this->destination, '/')) $this->destination .= '/';
    ...
    function set_file($file): void {
      $this->file = $file;
    }

    function set_destination($destination): void {
      $this->destination = $destination;
    }

    function set_permissions($permissions): void {
      $this->permissions = octdec($permissions);
    }

    function set_filename($filename): void {
      $this->filename = $filename;
    }

    function set_tmp_filename($filename): void {
      $this->tmp_filename = $filename;
    }

    function set_extensions($extensions): void {
    ...
    function check_destination(): bool {
      $OSCOM_MessageStack = Registry::get('MessageStack');
    ...
    function set_output_messages($location): void {
