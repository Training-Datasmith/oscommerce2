            ...
            case 'delete_category':
                if (isset($cInfo)) {
                    ...
                    if ($cInfo->childs_count > 0) {
                        $contents[] = ['text' => OSCOM::getDef('text_delete_warning_childs', ['childs_count' => $cInfo->childs_count])];
                    }
                    if ($cInfo->products_count > 0) {
                        $contents[] = ['text' => OSCOM::getDef('text_delete_warning_products', ['products_count' => $cInfo->products_count])];
                    }
