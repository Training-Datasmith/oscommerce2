...
<?php
  if (($action == 'new') || ($action == 'edit')) {
      ...
      ?>
      <tr><form name="new_special" action="<?php echo OSCOM::link(FILENAME_SPECIALS, tep_get_all_get_params(['action', 'info', 'sID']) . 'action=' . $form_action); ?>" method="post"><?php if ($form_action == 'update') {
      ...
      echo HTML::hiddenField('products_price', ($sInfo->products_price ?? '')); ?></td>
          </tr>
          <tr>
