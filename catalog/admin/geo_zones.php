        ...
        default:
            if (isset($sInfo) && is_object($sInfo)) {
                ...
                if (tep_not_null($sInfo->last_modified)) {
                    $contents[] = ['text' => OSCOM::getDef('text_info_last_modified') . ' ' . DateTime::toShort($sInfo->last_modified)];
                }
            }
            break;
    }
        ...
        default:
            if (isset($zInfo) && is_object($zInfo)) {
                ...
                if (tep_not_null($zInfo->last_modified)) {
                    $contents[] = ['text' => OSCOM::getDef('text_info_last_modified') . ' ' . DateTime::toShort($zInfo->last_modified)];
                }
