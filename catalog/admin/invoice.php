...
echo OSCOM::link_public('Templates/Sail/css/stylesheet.css');
?>">
</head>
<body>
...
echo HTML::image(OSCOM::link_image('Shop/' . STORE_LOGO), STORE_NAME);
?></td>
      </tr>
    </table></td>
  </tr>
...
echo OSCOM::get_def('entry_sold_to');
?></strong></td>
          </tr>
          <tr>
            <td class="main"><?php 
...
?></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><strong><?php 
echo OSCOM::get_def('entry_ship_to');
?></strong></td>
          </tr>
          <tr>
            <td class="main"><?php 
