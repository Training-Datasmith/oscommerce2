...
while ($Qproducts->fetch()) {
    ...
    echo OSCOM::link(FILENAME_CATEGORIES, 'action=new_product_preview&read=only&pID=' . $Qproducts->value_int('products_id') . '&origin=' . FILENAME_STATS_PRODUCTS_VIEWED . '&page=' . $_GET['page']);
    ?>'">
                <td class="dataTableContent"><?php 
    echo $rows;
    ?>.</td>
                <td class="dataTableContent"><?php 
    echo '<a href="' . OSCOM::link(FILENAME_CATEGORIES, 'action=new_product_preview&read=only&pID=' . $Qproducts->value_int('products_id') . '&origin=' . FILENAME_STATS_PRODUCTS_VIEWED . '&page=' . $_GET['page']) . '">' . $Qproducts->value('products_name') . '</a> (' . $Qproducts->value('name') . ')';
    ?></td>
                <td class="dataTableContent" align="center"><?php 
    echo $Qproducts->value_int('products_viewed');
    ?>&nbsp;</td>
              </tr>
<?php 
}
...
echo $Qproducts->get_page_set_label(OSCOM::get_def('text_display_number_of_products'));
?></td>
